...
static struct dvfs dvfs_init[] = {
    ...
    CORE_DVFS("2d",      1, KHZ, 133000, 171000, 247000, 350000, 350000, 350000, 350000, 350000, 350000),
    CORE_DVFS("3d",      1, KHZ, 218500, 256500, 323000, 380000, 380000, 450000, 450000, 450000, 450000),
