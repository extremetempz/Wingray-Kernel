...
static struct dvfs dvfs_init[] = {
    ...
    CORE_DVFS("emc",     1, KHZ, 57000, 333000, 333000, 666000, 666000, 666000, 760000, 900000, 900000),
    ...
    CORE_DVFS("epp",     1, KHZ, 133000, 171000, 247000, 300000, 300000, 300000, 300000, 300000, 350000),
    CORE_DVFS("2d",      1, KHZ, 133000, 171000, 247000, 300000, 300000, 300000, 300000, 300000, 350000),
    CORE_DVFS("3d",      1, KHZ, 218500, 256500, 323000, 380000, 380000, 400000, 400000, 400000, 450000),
    ...
    CORE_DVFS("sclk",    1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 300000, 300000, 300000),
