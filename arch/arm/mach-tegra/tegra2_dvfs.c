...
static struct dvfs dvfs_init[] = {
    ...
    CORE_DVFS("epp",     1, KHZ, 111000, 171000, 247000, 300000, 300000, 300000, 300000, 300000, 400000),
    CORE_DVFS("2d",      1, KHZ, 111000, 171000, 247000, 300000, 300000, 300000, 300000, 300000, 350000),
    CORE_DVFS("3d",      1, KHZ, 87000, 256500, 323000, 380000, 380000, 400000, 400000, 450000, 500000),
