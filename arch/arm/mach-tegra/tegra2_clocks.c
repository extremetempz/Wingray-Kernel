...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
    /* 1.704 GHz */
    { 12000000, 1700000000, 852, 6, 1, 12},
    { 13000000, 1700000000, 1049, 8, 1, 12},
    { 19200000, 1700000000, 1065, 12, 1, 8},
    { 26000000, 1700000000, 852, 13, 1, 12},
    ...
    { 26000000, 1400000000, 704, 13, 1, 12},
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("3d",	"3d",			NULL,	24,	0x158,	475000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | PERIPH_MANUAL_RESET), /* scales with voltage and process_id */
#else
	PERIPH_CLK("3d",	"3d",			NULL,	24,	0x158,	475000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | PERIPH_MANUAL_RESET), /* scales with voltage and process_id */
#endif
	PERIPH_CLK("2d",	"2d",			NULL,	21,	0x15c,	350000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
	PERIPH_CLK("vi",	"tegra_camera",		"vi",	20,	0x148,	150000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
	PERIPH_CLK("vi_sensor",	"tegra_camera",		"vi_sensor",	20,	0x1a8,	150000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | PERIPH_NO_RESET), /* scales with voltage and process_id */
	PERIPH_CLK("epp",	"epp",			NULL,	19,	0x16c,	400000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
